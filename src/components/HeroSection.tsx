        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center min-h-[60vh]">
          ...
          <div className="space-y-8 animate-slide-in">
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
              <div className="text-center bg-secondary/10 backdrop-blur-sm rounded-lg p-4">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Button 
                ...
                className="bg-secondary hover:bg-secondary/90 text-secondary-foreground font-semibold px-8 py-6 text-lg rounded-full group"
              >
              ...
              <Button 
                ...
                className="border-2 border-secondary text-secondary hover:bg-secondary hover:text-secondary-foreground font-semibold px-8 py-6 text-lg rounded-full"
              >
                Fale Conosco
              </Button>
            </div>
          ...
          <div className="relative animate-fade-in">
            <div className="relative">
              ...
              <div className="bg-secondary/10 backdrop-blur-sm rounded-3xl p-8 shadow-strong">
                <div className="aspect-square bg-gradient-to-br from-secondary/20 to-secondary/5 rounded-2xl flex items-center justify-center overflow-hidden">
                  <img 
              ...
              {/* Floating elements */}
              <div className="absolute -top-4 -right-4 bg-secondary text-secondary-foreground rounded-full p-4 shadow-lg animate-pulse">
                <Star className="h-6 w-6" />
              </div>
              <div className="absolute -bottom-4 -left-4 bg-background text-foreground rounded-full p-3 shadow-lg">
